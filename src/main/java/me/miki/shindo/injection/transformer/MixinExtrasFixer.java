        ...
        for (MethodNode method : node.methods) {
            ...
            while (iterator.hasNext()) {
                ...
                if (!foundNew && !foundDup && instruction.getOpcode() == NEW &&
                    ...
                    iterator.set(new MethodInsnNode(INVOKESTATIC, "me/miki/shindo/injection/transformer/MixinExtrasFixer", "redirect", "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Lorg/objectweb/asm/Handle;"));
                }
            }
        }
