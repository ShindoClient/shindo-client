...
public class SpongeForgeFixer implements IClassTransformer, Opcodes {
    ...
    public static final Logger LOGGER = LogManager.getLogger("[SC/MIXINBOOTER]");
    ...
    public byte[] transform(String name, String transformedName, byte[] classBytes) {
        if ("org.spongepowered.asm.util.PrettyPrinter".equals(name)) {
            LOGGER.info("Transforming PrettyPrinter to include old removed methods for SpongeForge.");
    ...
    private void exempt() {
        try {
            ...
            LOGGER.fatal("Cannot exempt org.spongepowered.asm.util. package from being excluded by the class loader," +
