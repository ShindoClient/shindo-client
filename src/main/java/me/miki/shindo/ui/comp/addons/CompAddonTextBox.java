...
public class CompAddonTextBox extends CompTextBoxBase {

    private final TextSetting setting;
    private final TimerUtils timer = new TimerUtils();

    public CompAddonTextBox(float x, float y, float width, float height, TextSetting setting) {
        super(x, y, width, height);
        this.setting = setting;
        this.setText(setting.getText());
    }

    public CompAddonTextBox(TextSetting setting) {
        super(0, 0, 0, 0);
        this.setting = setting;
        this.setText(setting.getText());
    }
