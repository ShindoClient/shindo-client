...
public class SolidPixelWrapper {
    ...
    private static final SkinDirection[] hiddenDirN = new SkinDirection[]{SkinDirection.WEST, SkinDirection.EAST, SkinDirection.UP,
            SkinDirection.DOWN};
    private static final SkinDirection[] hiddenDirS = new SkinDirection[]{SkinDirection.EAST, SkinDirection.WEST, SkinDirection.UP,
            SkinDirection.DOWN};
    private static final SkinDirection[] hiddenDirW = new SkinDirection[]{SkinDirection.SOUTH, SkinDirection.NORTH, SkinDirection.UP,
            SkinDirection.DOWN};
    private static final SkinDirection[] hiddenDirE = new SkinDirection[]{SkinDirection.NORTH, SkinDirection.SOUTH, SkinDirection.UP,
            SkinDirection.DOWN};
    private static final SkinDirection[] hiddenDirUD = new SkinDirection[]{SkinDirection.EAST, SkinDirection.WEST, SkinDirection.NORTH,
            SkinDirection.SOUTH};
