...
public class AssetManager {
    ...
    private final HashMap<String, NVGAsset> imageCache = new HashMap<String, NVGAsset>();
    private final HashMap<Integer, Integer> glTextureCache = new HashMap<Integer, Integer>();
    private final HashMap<String, NVGAsset> svgCache = new HashMap<String, NVGAsset>();
