...
public class CapesScene extends CosmeticScene {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        nvg.save();
        nvg.translate(0, getParent().scroll.getValue());
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        ...
        int offsetX = 0;
        float offsetY = 13 + getParent().scroll.getValue();
        CapeManager capeManager = instance.getCapeManager();
        int index = 1;
    ...
    private boolean filterCape(Cape cape) {
        ...
        return !getParent().getSearchBox().getText().isEmpty() && !SearchUtils.isSimillar(cape.getName(), getParent().getSearchBox().getText());
    }
}
