...
public class GeneralScene extends SettingScene {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int offsetY = 0;
        drawItemInList(TranslateText.OPEN_MOD_MENU.getText(), "Choose which key should open this GUI", this.getY(), offsetY, 87, modMenuKeybind, nvg, palette, mouseX, mouseY, partialTicks);
        offsetY += 51;
        drawItemInList(TranslateText.CLICK_EFFECT.getText(), TranslateText.CLICK_EFFECT_DESCRIPTION.getText(), this.getY(), offsetY, 46, clickEffectSetting, nvg, palette, mouseX, mouseY, partialTicks);
        offsetY += 51;
        drawItemInList(TranslateText.UI_SOUNDS.getText(), TranslateText.UI_SOUNDS_DESCRIPTION.getText(), this.getY(), offsetY, 46, soundsUISetting, nvg, palette, mouseX, mouseY, partialTicks);
        offsetY += 51;
        drawItemInList(TranslateText.MC_FONT.getText(), "If the client should use the minecraft font for the hud", this.getY(), offsetY, 46, mcFontSetting, nvg, palette, mouseX, mouseY, partialTicks);
        offsetY += 51;
    }
