package com.shindoclient.shindo.mobends.client.renderer;

import com.shindoclient.shindo.management.mods.impl.MoBendsMod;
import com.shindoclient.shindo.mobends.client.model.ModelRendererBends;
import com.shindoclient.shindo.mobends.client.model.entity.ModelBendsPlayer;
import com.shindoclient.shindo.mobends.util.MoBendsGUtil;
...
public class SwordTrail {
    ...
    public void render(ModelBendsPlayer model) {
        ...
        for (int i = 0; i < this.trailPartList.size(); i++) {
            ...
            MoBendsGUtil.rotateX(point, part.foreArm.pre_rotation.getX());
            MoBendsGUtil.rotateY(point, part.foreArm.pre_rotation.getY());
            MoBendsGUtil.rotateZ(point, -part.foreArm.pre_rotation.getZ());
            ...
            MoBendsGUtil.rotateX(point, part.arm.pre_rotation.getX());
            MoBendsGUtil.rotateY(point, part.arm.pre_rotation.getY());
            MoBendsGUtil.rotateZ(point, -part.arm.pre_rotation.getZ());
            ...
            MoBendsGUtil.rotateX(point, part.body.pre_rotation.getX());
            MoBendsGUtil.rotateY(point, part.body.pre_rotation.getY());
            MoBendsGUtil.rotateZ(point, part.body.pre_rotation.getZ());
