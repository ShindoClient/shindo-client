package com.shindoclient.shindo.injection.transformer;
        ...
        if (name.equals("org.lwjgl.nanovg.NanoVGGLConfig")) {
            ...
            for (Object methodObj : node.methods) {
                ...
                if (method.name.equals("configGL")) {
                    ...
                    list.add(new TypeInsnNode(Opcodes.NEW, "com/shindoclient/shindo/injection/transformer/Lwjgl2FunctionProvider"));
                    list.add(new InsnNode(Opcodes.DUP));
                    list.add(new MethodInsnNode(
                            Opcodes.INVOKESPECIAL,
                            "com/shindoclient/shindo/injection/transformer/Lwjgl2FunctionProvider",
                            "<init>",
                            "()V",
                            false
                    ));
