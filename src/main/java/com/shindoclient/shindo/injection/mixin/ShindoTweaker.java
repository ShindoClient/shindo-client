package com.shindoclient.shindo.injection.mixin;

//import com.llamalad7.mixinextras.MixinExtrasBootstrap;

import com.shindoclient.shindo.injection.transformer.LwjglTransformer;
        ...
        try {
            ...
            for (String excludedPackage : new ArrayList<>(classLoaderExceptions)) {
                ...
                if ("org.lwjgl.".equals(excludedPackage)
                        || excludedPackage.startsWith("com.shindoclient.shindo.injection.mixin")
                        || excludedPackage.startsWith("com.shindoclient.shindo.injection.interfaces")
                        || excludedPackage.startsWith("com.shindoclient.shindo.injection.mixin.accessors")) {
