package com.shindoclient.shindo.injection.mixin.minecraft.client.renderer.entity.layer;
...
public abstract class MixinLayerHeldItem {
    ...
    public void doRenderLayer(EntityLivingBase entitylivingbaseIn, float f, float g, float partialTicks, float h, float i, float j, float scale) {
        ...
        if (itemStack != null) {
            ...
            if (mod.isToggled() && sneak != null && sneak.isToggled() && entitylivingbaseIn.isSneaking()) {
            ...
            if (mod.isToggled() && blockHitSetting != null && blockHitSetting.isToggled()) {
