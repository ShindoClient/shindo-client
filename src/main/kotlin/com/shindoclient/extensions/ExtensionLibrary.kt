package com.shindoclient.extensions

import com.shindoclient.extensions.core.ExtensionManager

object ExtensionLibrary {
    const val BASE_PACKAGE: String = "com.shindoclient.extensions"
    ...
    private fun registerUi(manager: ExtensionManager) {
        ...
        manager.register {
            id = "com.shindoclient.extensions.ui.animation"
        ...
        manager.register {
            id = "com.shindoclient.extensions.ui.nanovg"
    ...
    private fun registerNetwork(manager: ExtensionManager) {
        ...
        manager.register {
            id = "com.shindoclient.extensions.network.okhttp"
        ...
        manager.register {
            id = "com.shindoclient.extensions.network.http"
            namespace = "$base.http"
        ...
        manager.register {
            id = "com.shindoclient.extensions.network.proxy"
    ...
    private fun registerUtils(manager: ExtensionManager) {
        ...
        manager.register {
            id = "com.shindoclient.extensions.utils.mouse"
    ...
    private fun registerSerialization(manager: ExtensionManager) {
        ...
        manager.register {
            id = "com.shindoclient.extensions.serialization.gson"
            namespace = "$base.gson"
