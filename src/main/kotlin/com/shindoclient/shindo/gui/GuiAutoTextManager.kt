...
import com.shindoclient.shindo.management.autotext.AutoTextEntry
...
import com.shindoclient.shindo.ui.components.v2.inputs.CompAutoTextKeybind
...
class GuiAutoTextManager(
    ...
    private fun drawCard(
        ...
        val deleteY = cardY + (cardHeight - deleteSize) - 8
        val actionX = deleteX - actionGap - actionSize
        val contentWidth = cardWidth - 20f
        ...
        val actionHovered = MouseUtils.isInside(mouseX, mouseY, actionX, deleteY, actionSize, actionSize)
    ...
    override fun mouseClicked(
        ...
        val addX = x + menuWidth - 30f
        val addY = y
        if (MouseUtils.isInside(mouseX, mouseY, addX + 5, addY + 10f, 12f, 12f)) {
        ...
        for (card in cards) {
            ...
            if (MouseUtils.isInside(mouseX, mouseY, actionX, deleteY, actionSize, actionSize)) {
                if (card.editing) {
