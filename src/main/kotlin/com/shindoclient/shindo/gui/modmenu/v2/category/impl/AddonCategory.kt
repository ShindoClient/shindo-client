...
import com.shindoclient.shindo.gui.modmenu.v2.category.impl.addon.AddonCategoryRenderer
import com.shindoclient.shindo.gui.modmenu.v2.category.list.ModMenuListCardLayoutSpec
import com.shindoclient.shindo.gui.modmenu.v2.category.list.ModMenuListPageContract
import com.shindoclient.shindo.gui.modmenu.v2.category.list.ModMenuListPageRenderContext
import com.shindoclient.shindo.gui.modmenu.v2.navigation.ModMenuSlideTransitionCoordinator
import com.shindoclient.shindo.gui.modmenu.v2.render.ModMenuListCardLayout
import com.shindoclient.shindo.gui.modmenu.v2.render.ModMenuSettingsOverlayRenderer
...
import com.shindoclient.shindo.management.addons.data.FailedAddonEntry
...
import com.shindoclient.shindo.ui.components.v2.chips.CategoryChipRenderer
import com.shindoclient.shindo.ui.components.v2.chips.FilterChip
import com.shindoclient.shindo.ui.components.v2.layout.SettingsPanel
import com.shindoclient.shindo.ui.components.v2.layout.settingspanel.SettingsPanelStyle
import com.shindoclient.shindo.utils.SearchUtils
import com.shindoclient.shindo.utils.TextUtils
...
class AddonCategory(
    ...
    override fun initGui() {
        ...
        resetSpinAnimation.setValue(0f)
        resetSpinTarget = 0f
        currentAddon = null
        settingsPanel.clear()
    }
    ...
    override fun drawEntryCards(
        ...
        val addonManager = Shindo.getInstance().getAddonManager()
        ...
        for (card in addonCardCache) {
            ...
            val toggleProgress = addon.animation.getValue()
