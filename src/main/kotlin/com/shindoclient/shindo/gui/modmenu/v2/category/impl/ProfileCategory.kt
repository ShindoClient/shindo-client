...
import com.shindoclient.shindo.management.profile.ProfileIcon
...
import com.shindoclient.shindo.management.profile.ProfileType
...
import com.shindoclient.shindo.utils.IOUtils
...
class ProfileCategory(
    ...
    private fun isActiveProfile(profile: Profile): Boolean {
        ...
        return try {
            af.canonicalPath == pf.canonicalPath
        } catch (e: Exception) {
            af.absolutePath == pf.absolutePath
        }
    }
