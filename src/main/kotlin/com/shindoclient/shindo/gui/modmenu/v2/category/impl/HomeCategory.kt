...
import com.shindoclient.shindo.gui.modmenu.v2.category.impl.home.HomeCategoryInputController
...
import com.shindoclient.shindo.management.remote.changelog.Changelog
...
import com.shindoclient.shindo.management.remote.news.News
...
class HomeCategory(
    ...
    override fun drawScreen(
        ...
        val changelogManager: ChangelogManager = instance.getChangelogManager()
        val newsManager: NewsManager = instance.getNewsManager()
        val discStat: DiscordStats = instance.getDiscordStats()
    ...
    override fun mouseClicked(
        ...
        val musicManager: MusicManager = Shindo.getInstance().getMusicManager()
