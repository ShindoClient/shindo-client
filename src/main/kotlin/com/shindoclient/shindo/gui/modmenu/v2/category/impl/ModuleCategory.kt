...
import com.shindoclient.shindo.gui.modmenu.v2.category.impl.module.ModuleCategoryRenderer
...
class ModuleCategory(
    ...
    override fun drawEntryCards(
        ...
        val modManager = Shindo.getInstance().getModManager()
        ...
        for (card in moduleCardCache) {
            ...
            val toggleProgress = card.mod.animation.getValue()
