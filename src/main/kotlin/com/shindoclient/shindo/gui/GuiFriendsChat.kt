...
import com.shindoclient.shindo.api.chat.ChatFriend
import com.shindoclient.shindo.api.chat.ChatRequest
...
import com.shindoclient.shindo.utils.PlayerHeadUtils
...
class GuiFriendsChat(
    ...
    private fun sendMessage() {
        ...
        chatManager.sendMessage(friend.uuid, text) { result ->
            if (result is com.shindoclient.shindo.api.chat.ChatManager.MessageSendResult.Success) {
                messageBox.setText("")
            }
        }
    }
