package com.shindoclient.shindo.management.settings.metadata
...
import com.shindoclient.shindo.management.settings.config.SettingCategoryProvider
...
import com.shindoclient.shindo.management.settings.impl.ImageSetting
...
import com.shindoclient.shindo.management.settings.impl.SoundSetting
...
object SettingRegistry {
    ...
    private fun createSettingFromProperty(
        ...
        try {
            ...
            when (property.type) {
                com.shindoclient.shindo.management.settings.config.PropertyType.BOOLEAN -> {
                ...
                com.shindoclient.shindo.management.settings.config.PropertyType.NUMBER -> {
                    createNumberSetting(
                        owner,
                        field,
                        target,
                ...
                com.shindoclient.shindo.management.settings.config.PropertyType.TEXT -> {
                    createTextSetting(
                        owner,
                        field,
                        target,
                ...
                com.shindoclient.shindo.management.settings.config.PropertyType.COLOR -> {
                    createColorSetting(
                        owner,
                        field,
                        target,
                ...
                com.shindoclient.shindo.management.settings.config.PropertyType.KEYBIND -> {
                ...
                com.shindoclient.shindo.management.settings.config.PropertyType.IMAGE -> {
                    createImageSetting(
                        owner,
                        field,
                        target,
                ...
                com.shindoclient.shindo.management.settings.config.PropertyType.SOUND -> {
                    createSoundSetting(
                        owner,
                        field,
                        target,
                ...
                com.shindoclient.shindo.management.settings.config.PropertyType.COMBO -> {
                    createComboSetting(
                        owner,
                        field,
                        target,
                ...
                com.shindoclient.shindo.management.settings.config.PropertyType.CELL_GRID -> {
