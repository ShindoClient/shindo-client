...
class GhosthandCheck : Check() {
    ...
    override fun check(player: EntityPlayer, data: PlayerDataSamples): Boolean {
        ...
        val lookEndPos =
            eyePos.addVector(lookVect.xCoord * maxReach, lookVect.yCoord * maxReach, lookVect.zCoord * maxReach)
        ...
        val nearbyPlayers = getPlayersDataInAABBexcluding(
            ...
            player.entityBoundingBox.addCoord(
                lookVect.xCoord * distance,
                lookVect.yCoord * distance,
                lookVect.zCoord * distance
