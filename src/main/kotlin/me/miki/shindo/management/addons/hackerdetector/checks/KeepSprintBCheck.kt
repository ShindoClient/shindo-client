...
/**
 * Detecta se a velocidade do jogador não diminui após atacar outros jogadores
 */
class KeepSprintBCheck : Check() {
            ...
            if (prevSpeedXZ > 4.0) {
                if (speedXZ > 0.9 * prevSpeedXZ) {
                    ...
                    if (HackerDetectorAddon.instance.debugLoggingSetting) {
                        log(player, data, data.keepSprintBVL,
    ...
    private fun accel(list: me.miki.shindo.management.addons.hackerdetector.data.SampleListD): Double {
