...
/**
 * Keeps sidebar slot geometry and interaction state out of [me.miki.shindo.gui.modmenu.v1.GuiModMenu].
 */
class ModMenuSidebarController {
    ...
    fun draw(
        ...
        nvg.drawGradientRoundedRect(
            first.x,
            first.y + activeSlotAnimation.value,
            first.size,
            first.size,
            5f,
            accent.getColor1(),
        ...
        for (i in slots.indices) {
            ...
            val targetColor = when {
                ...
                hoverAnimation.value > 0.01f -> ColorUtils.interpolateColor(
                    normalColor,
                    hoverColor,
