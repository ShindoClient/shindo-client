...
class ScreenshotCategory(parent: GuiModMenu?) :
    ...
    override fun initGui() {
        val screenshotManager: ScreenshotManager = Shindo.getInstance().screenshotManager
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        val screenshotManager: ScreenshotManager = instance.screenshotManager
        ...
        if (currentScreenshot != null) {
            ...
            val leftValue: Float = leftAnimation.value
            val rightValue: Float = rightAnimation.value
