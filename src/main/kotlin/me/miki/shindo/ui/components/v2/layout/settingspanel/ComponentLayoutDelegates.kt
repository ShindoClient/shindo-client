...
interface ComponentLayoutDelegate {
    ...
    fun targetHeight(comp: Component, narrow: Boolean, style: SettingsPanelStyle): Float
    fun place(comp: Component, context: ComponentLayoutContext): ComponentPlacement
...
class ComponentLayoutRegistry(private val delegates: List<ComponentLayoutDelegate>) {
    ...
    private val fallback = object : ComponentLayoutDelegate {
        ...
        override fun targetHeight(comp: Component, narrow: Boolean, style: SettingsPanelStyle): Float {
            return if (narrow) style.minRowHeightNarrow else style.minRowHeightDefault
        }

        override fun place(comp: Component, context: ComponentLayoutContext): ComponentPlacement {
