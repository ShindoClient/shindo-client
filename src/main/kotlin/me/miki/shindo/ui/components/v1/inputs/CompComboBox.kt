...
class CompComboBox : Comp {
    ...
    override fun draw(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        changeAnimation.setAnimation(changeDirection.toFloat(), 16)
        ...
        nvgInstance.drawCenteredText(
            ...
            this.getX() + (width / 2f) + ((changeDirection - changeAnimation.value) * 22f),
            this.getY() + 5f,
            Color(255, 255, 255, (MathUtils.abs(changeAnimation.value * 255)).toInt()),
            8f,
            Fonts.REGULAR
        )
