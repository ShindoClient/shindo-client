...
class CompSettingButton : Comp {
    ...
    fun onClick(onClick: () -> Unit): CompSettingButton {
    ...
    override fun mouseClicked(mouseX: Int, mouseY: Int, mouseButton: Int) {
        ...
        trailingComp?.let {
            insideTrailing = MouseUtils.isInside(mouseX, mouseY, it.getX(), it.getY(), it.getWidth(), it.getHeight())
        }

        if (!insideTrailing && mouseButton == 0 && onClickAction != null && isHovered(mouseX, mouseY)) {
