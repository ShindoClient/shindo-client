...
/**
 * Renderizador customizado para o menu de opções do Minecraft (GuiOptions).
 * Aplica o estilo visual do Shindo Client mantendo toda a funcionalidade original.
 */
object MinecraftOptionsScreenRenderer {
    
    /**
     * Renderiza o fundo e layout do menu de opções com o estilo do Shindo Client.
     */
    fun renderOptionsScreen(screen: GuiOptions, mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        // Renderiza painel central para os botões (opcional, apenas visual)
        val panelWidth = 400f
        ...
        val title = net.minecraft.client.resources.I18n.format("options.title")
        ...
        // Sombra do título
        val shadowColor = ColorUtils.applyAlpha(Color.BLACK, 100)
